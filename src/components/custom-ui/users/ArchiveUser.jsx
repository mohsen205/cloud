...
const ArchiveUser = ({ open, setOpen, id }) => {
  ...
  const handleConfirm = () => {
    setSubmitting(true);
    api
      .put(`${httpsEndpoint}/user/${id}/archive`, {
        headers: {
      ...
      .then(_ => {
        setHandleOpenSnackbar({
          open: true,
          severity: "success",
          message: "Le Travailleur a été archivé avec succès.",
        });
    ...
    <>
      ...
      >
        <Typography variant="h6" component="h2">
          Êtes-vous sûr(e) de vouloir archiver cette user ?
        </Typography>
