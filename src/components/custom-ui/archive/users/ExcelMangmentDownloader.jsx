...
const validationSchema = Yup.object().shape(
  {
    ...
    fields: Yup.array().of(Yup.string()), // Fields array, not required
  },

  ["endDate", "startDate"],
);

const ExcelMangmentDownloader = ({ open, setOpen }) => {
  ...
  const onSubmit = (values, actions) => {
    ...
    api
      .get(`${httpsEndpoint}/users/generate-excel?${params.toString()}`, {
        headers: {
      ...
      .then(response => {
        ...
        link.setAttribute(
          "download",
          `${worksheetName || "Feuille des utilisateurs"}.xlsx`,
        );
      ...
      >
        ...
        >
          <Typography variant="h6" color="initial">
            Liste des travailleurs archivés
          </Typography>
                ...
                <FormControl variant="standard">
                  ...
                  <FormControl variant="standard">
                    ...
                    <Stack direction="row" sx={{ marginTop: "10px" }}>
                      <FormGroup>
                        {labeledDataWithIndex.slice(0, 7).map(data => {
                          return (
                            <BSCheckBox
                              key={data.index}
                              name="fields"
                      ...
                      <FormGroup>
                        {labeledDataWithIndex.slice(7).map(data => {
                          return (
                            <BSCheckBox
                              key={data.index}
                              name="fields"
