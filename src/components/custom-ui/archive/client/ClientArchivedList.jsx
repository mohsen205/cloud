...
import { useArchivedClientColumn } from "../../../columns";
...
const ClientArchivedList = () => {
  ...
  const fetchClients = async () => {
    const response = await api.get(`${httpsEndpoint}/clients`, {
      headers: {
  ...
  const columns = useArchivedClientColumn();
